...
@interface MTEAppDelegate () <MTELoginWindowDelegate>

@property (nonatomic, strong) NSArray *tshirtsSortDescriptors;

@property (nonatomic, strong) MTESyncManager *syncManager;

@property (nonatomic, strong) MTELoginWindowController *loginWindowController;
...
{
    self.tshirtsSortDescriptors = @[[NSSortDescriptor sortDescriptorWithKey:@"name" ascending:YES]];
...
- (void)showLoginWindow
{
    ...
    if (!self.loginWindowController) {
        self.loginWindowController = [[MTELoginWindowController alloc] init];
    }
...
#pragma mark - Login window delegate
                     ...
                     password:(NSString *)password
{
    [[MTEMyTeeAPIClient sharedClient] sendAuthenticationRequestWithUsername:email password:password success:^{
        ...
        [[NSAlert alertWithMessageText:NSLocalizedString(@"Login Failed", nil)
...
// Returns the directory the application uses to store the Core Data store file. This code uses a directory named "com.studioamanga.MyTee_OSX" in the user's Application Support directory.
- (NSURL *)applicationFilesDirectory
{
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSURL *appSupportURL = [[fileManager URLsForDirectory:NSApplicationSupportDirectory inDomains:NSUserDomainMask] lastObject];
    return [appSupportURL URLByAppendingPathComponent:@"com.studioamanga.mytee-osx"];
}
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"mytee-osx.storedata"];
